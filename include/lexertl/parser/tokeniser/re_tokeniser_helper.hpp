        ...
        private:
            ...
            static const char* unicode_escape(state_type& state_)
            {
                ...
                case 'L':
                    ...
                    {
                    case '}':
                        str_ = R"([\p{Ll}\p{Lm}\p{Lo}\p{Lt}\p{Lu}])";
                        break;
                    case 'C':
                        str_ = R"([\p{Ll}\p{Lt}\p{Lu}])";
                        state_.increment();
                        break;
                    case 'l':
